...
#if COMPILER_MSVC
#define MATH_EQUATION_QUADRATIC_INSTANTIATE(TYPE, SUFFIX, SQRT, CSQRT)         \
  MATH_EQUATION_QUADRATIC_DISCRIMINANT_IMPLEMENT(TYPE, SUFFIX)                 \
  MATH_EQUATION_QUADRATIC_IMPLEMENT(TYPE, SUFFIX, SQRT)
#else
#define MATH_EQUATION_QUADRATIC_INSTANTIATE(TYPE, SUFFIX, SQRT, CSQRT)         \
  MATH_EQUATION_QUADRATIC_DISCRIMINANT_IMPLEMENT(TYPE, SUFFIX)                 \
  MATH_EQUATION_QUADRATIC_IMPLEMENT(TYPE, SUFFIX, SQRT)                        \
  MATH_EQUATION_QUADRATIC_COMPLEX_IMPLEMENT(                                   \
      TYPE, TYPE _Complex, SUFFIX, CSQRT)
#endif

MATH_EQUATION_QUADRATIC_INSTANTIATE(float, F32, sqrtf, csqrtf)
MATH_EQUATION_QUADRATIC_INSTANTIATE(double, F64, sqrt, csqrt)
MATH_EQUATION_QUADRATIC_INSTANTIATE(long double, F128, sqrtl, csqrtl)
